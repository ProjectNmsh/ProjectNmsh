...
RegisterNetEvent('qb-mdt:client:selfregister')
AddEventHandler('qb-mdt:client:selfregister', function()
...
if Config.UseWolfknightRadar == true then
    RegisterNetEvent("qb-mdt:client:trafficStop")
    AddEventHandler("qb-mdt:client:trafficStop", function()
