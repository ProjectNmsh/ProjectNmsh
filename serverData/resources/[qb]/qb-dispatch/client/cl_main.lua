...
RegisterNetEvent("qb-dispatch:client:AddCallBlip", function(coords, data, blipId)
...
RegisterNetEvent("qb-dispatch:client:removeCallBlip", function(blipId)
	RemoveBlip(blips[blipId])
	RemoveBlip(radius2[blipId])
end)

RegisterNetEvent("qb-dispatch:client:clearAllBlips", function()
