...
- [nmsh-multicharacter](https://github.com/qbcore-framework/nmsh-multicharacter) - Checking if player is inside after character chosen (You need to edit the lines if you don't use this)
