...
RegisterNetEvent('nmsh-fitbit:use', function()
    openWatch()
end)
...
RegisterNUICallback('setFoodWarning', function(data, cb)
    ...
    TriggerServerEvent('nmsh-fitbit:server:setValue', 'food', foodValue)
...
RegisterNUICallback('setThirstWarning', function(data, cb)
    ...
    TriggerServerEvent('nmsh-fitbit:server:setValue', 'thirst', thirstValue)
