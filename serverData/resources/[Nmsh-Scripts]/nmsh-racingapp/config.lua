...
Config.ShowMechToolOption = true -- set to false if you dont use nmsh-mechtool
...
Config.Classes = {
    ...
    ['A'] = true,
    ['S'] = true
} -- These classes can be used (notice X missing for example). Only use classes from nmsh-performance here.
