...
### qb-target with pokemon shops ###
 ...
 If you dont want to use the qb-target go to client.lua in nmsh-pokemontcg and remove the exports at the bottom.
...
## Original nmsh-pokemontcg

- [nmsh-pokemontcg](https://github.com/KamuiKody/qb-pokemontcg)
- 
