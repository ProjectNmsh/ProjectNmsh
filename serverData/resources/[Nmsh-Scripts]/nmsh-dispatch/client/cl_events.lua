...
RegisterNetEvent('nmsh-dispatch:client:drugsale', function()
    DrugSale()
end)
...
RegisterNetEvent("nmsh-dispatch:client:officerdown", function ()
    OfficerDown()
end)
...
RegisterNetEvent("nmsh-dispatch:client:emsdown", function ()
    EmsDown()
end)
