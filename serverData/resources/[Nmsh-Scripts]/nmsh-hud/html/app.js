...
function closeMenu() {
  ...
  $.post('https://nmsh-hud/closeMenu');
}
function restartHud() {
  closeMenu()
  $.post('https://nmsh-hud/restartHud');
}
function resetStorage() {
  closeMenu()
  $.post('https://nmsh-hud/resetStorage');
}
function showOutMap() {
  $.post('https://nmsh-hud/showOutMap');
}
function showOutCompass() {
  $.post('https://nmsh-hud/showOutCompass');
}
function showFollowCompass() {
  $.post('https://nmsh-hud/showFollowCompass');
}
function openMenuSounds() {
  $.post('https://nmsh-hud/openMenuSounds');
}
function resetHudSounds() {
  $.post('https://nmsh-hud/resetHudSounds');
}
function checklistSounds() {
  $.post('https://nmsh-hud/checklistSounds');
}
function showMapNotif() {
  $.post('https://nmsh-hud/showMapNotif');
}
function showFuelAlert() {
  $.post('https://nmsh-hud/showFuelAlert');
}
function showCinematicNotif() {
  $.post('https://nmsh-hud/showCinematicNotif');
}
function dynamicHealth() {
  $.post('https://nmsh-hud/dynamicHealth');
}
function dynamicArmor() {
  $.post('https://nmsh-hud/dynamicArmor');
}
function dynamicHunger() {
  $.post('https://nmsh-hud/dynamicHunger');
}
function dynamicThirst() {
  $.post('https://nmsh-hud/dynamicThirst');
}
function dynamicStress() {
  $.post('https://nmsh-hud/dynamicStress');
}
function dynamicOxygen() {
  $.post('https://nmsh-hud/dynamicOxygen');
}
function dynamicEngine() {
  $.post('https://nmsh-hud/dynamicEngine');
}
function dynamicNitro() {
  $.post('https://nmsh-hud/dynamicNitro');
}
function ToggleMapShape() {
  $.post('https://nmsh-hud/ToggleMapShape');
}
function changeFPS() {
  $.post('https://nmsh-hud/changeFPS');
}
function ToggleMapBorders() {
  $.post('https://nmsh-hud/ToggleMapBorders');
}
function HideMap() {
  $.post('https://nmsh-hud/HideMap');
}
function changeCompassFPS() {
  $.post('https://nmsh-hud/changeCompassFPS');
}
function showCompassBase() {
  $.post('https://nmsh-hud/showCompassBase');
}
function showStreetsNames() {
  $.post('https://nmsh-hud/showStreetsNames');
}
function showPointerIndex() {
  $.post('https://nmsh-hud/showPointerIndex');
}
function showDegreesNum() {
  $.post('https://nmsh-hud/showDegreesNum');
}
function cinematicMode() {
  $.post('https://nmsh-hud/cinematicMode');
}
