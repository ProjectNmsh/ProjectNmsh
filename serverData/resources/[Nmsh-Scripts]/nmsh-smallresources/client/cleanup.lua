...
AddEventHandler("nmsh-cleanup:addBlacklistedProp", function(pProp)
...
local bypassObjects = {}
AddEventHandler('nmsh-objects:objectCreated', function(pObject, pHandle)
    bypassObjects[pHandle] = true
end)

AddEventHandler('nmsh-objects:objectDeleted', function(pObject, pHandle)
    bypassObjects[pHandle] = nil
end)

AddEventHandler('nmsh-objects:objectRecreating', function(pObject, pHandle)
    bypassObjects[pHandle] = nil
end)

AddEventHandler('nmsh-objects:objectRecreated', function(pObject, pHandle)
    bypassObjects[pHandle] = true
end)
