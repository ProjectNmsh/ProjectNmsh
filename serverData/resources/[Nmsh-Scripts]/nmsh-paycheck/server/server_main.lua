...
RegisterNetEvent('nmsh-paycheck:server:AddMoneyToPayCheck', function(citizenid, amount, from)
     addmoney_to_paycheck(citizenid, amount, from)
end)

QBCore.Functions.CreateCallback('nmsh-paycheck:server:account_information', function(source, cb)
...
QBCore.Functions.CreateCallback('nmsh-paycheck:server:withdraw_all', function(source, cb)
     local Player = QBCore.Functions.GetPlayer(source)
     local citizenid = Player.PlayerData.citizenid
...
QBCore.Functions.CreateCallback('nmsh-paycheck:server:withdraw_amount', function(source, cb, amount)
     local Player = QBCore.Functions.GetPlayer(source)
     local citizenid = Player.PlayerData.citizenid
...
QBCore.Functions.CreateCallback('nmsh-paycheck:server:get_logs', function(source, cb, limit)
