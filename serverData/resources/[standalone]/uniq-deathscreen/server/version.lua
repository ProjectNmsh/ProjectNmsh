if Config.VersionChecking then
    Citizen.CreateThread(function ()
        ...
        PerformHttpRequest(('https://api.github.com/repos/uniqscripts/%s/releases/latest'):format(GetResourceMetadata(resource, 'name', 'uniq-deathscreen')), function(status, response)
